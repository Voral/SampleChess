...
<!--					<div id="tools">
			...
			<div id="info">
				...
				<div id="tab1c">
					...
					<ul>
						<li>Добавить влияние изменения количества игроков и шширины доски друг на друга. (для 4 игроков минимальная ширина 16)</li>
						<li>Автоматический предпросмотр доски (без фигур) при изменении конфиграции (до создания игры)</li>
						<li>При перемещении мышью ползунка </li>
					</ul>
					<h3>Сделать</h3>
					<ul>
